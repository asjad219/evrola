    ...
    <nav className={`navbar ${isScrolled ? 'navbar-scrolled' : ''}`}>
      <div className="container nav-container">
        <div className="logo">
          ...
          <span className="logo-text">Evro<span className="text-accent-blue">la</span></span>
        </div>
        ...
        <div className="nav-actions desktop-only">
          <button onClick={onOpenQuote} className="btn-clay-orange">
            Get Your Free Audit
          </button>
        </div>
      ...
      <div className={`mobile-menu-overlay ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-menu-content">
          ...
          <div className="mobile-menu-cta" style={{'--index': 6}}>
            <button 
              className="btn-clay-orange w-full text-center" 
